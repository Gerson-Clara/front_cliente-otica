          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" 
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Esqueceu sua senha?</a>
              </div>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Você não está cadastrado? <a href="/cadastro" className="font-medium text-blue-600 hover:underline dark:text-blue-500">
                  Cadastre-se</a>
              </p>
            </form>
          </div>
